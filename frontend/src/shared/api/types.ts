...
export type ApiProduct = { id: string; name: string; brand: string; unit: string; basePrice: number; category: string; gender: string; notes: string[]; source?: string; sourceUrl?: string | null; imageUrl?: string | null; available?: boolean; priceIsMock?: boolean; isSet?: boolean; matchedStores?: number; aliases?: string[]; offers?: ApiOffer[] };
